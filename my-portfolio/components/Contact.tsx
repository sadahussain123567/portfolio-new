        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div>
              ...
              <input
                ...
                className={`w-full px-4 py-3 bg-[#2a2a2a] border ${errors.name ? "border-red-500" : "border-gray-700"
            ...
            <div>
              ...
              <input
                ...
                className={`w-full px-4 py-3 bg-[#2a2a2a] border ${errors.email ? "border-red-500" : "border-gray-700"
                  } rounded-lg focus:outline-none focus:border-[#a7a6ff] transition-colors text-white placeholder-gray-500`}
              />
            </div>
          </div>
          ...
          <div>
            ...
            <textarea
              ...
              className={`w-full px-4 py-3 bg-[#2a2a2a] border ${errors.message ? "border-red-500" : "border-gray-700"
